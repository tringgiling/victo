...
#PREPROD CM huawei NBI nya ada di folder 5G
list_data_ericsson= []
list_data_5G= []
list_data_sisa= [] #kalau ada NL diluar NBI Huawei dan ERI
...
for daftar_file in os.listdir(folder_proses):
	...
	if "huawei/sd/5g" in nama_oss :
		list_data_5G.append(nama_oss +"%"+ jumlah_file_terproses +"%"+ status_task +"%"+ str(jumlah_sector) +"%"+ missing_sector +"%"+ missing_RET ) #% = buat pembatas
	...
	#kalau ada NL diluar NBI Huawei dan ERI
	elif "/" in nama_oss :
