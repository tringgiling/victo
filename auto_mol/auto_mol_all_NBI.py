...
# Huawei CM NBI ada di folder 5G
...
for daftar_file in os.listdir(folder_proses):
	...
	for baris in open (folder_proses + "/" +daftar_file, "r"):
		...
		if len(nama_oss) > 0 :
			...
			elif "5g" in simpan_nama_oss:
				list_data_5G_MOL.append(simpan_nama_oss +"%" + "".join(jumlah_file_terproses)) #% = buat pembatas
